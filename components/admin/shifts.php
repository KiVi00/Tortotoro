...
<div class="table__outer">
  ...
  <table class="table">
    ...
    <tbody class="table__body">
      <tr class="table__row">
        <td class="table__cell table-cell--dynamic">Виноградов К. С. (Повар)</td>
        <td class="table__cell table__cell--static">
          23.05.2025 (10:00&ndash;18:00)
        </td>
        <td class="table__cell table__cell--static">Закрыта</td>
      </tr>
      <tr class="table__row">
        <td class="table__cell table-cell--dynamic">Виноградов К. С. (Официант)</td>
        <td class="table__cell table__cell--static">24.05.2025 (10:00&ndash;18:00)</td>
        <td class="table__cell table__cell--static">Открыта</td>
      </tr>
    </tbody>
  </table>
</div>
