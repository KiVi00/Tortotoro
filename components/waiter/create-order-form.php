...
<form class="form form--modal form--two-columns" action="registration-form.php" method="post">
    ...
    <div class="form__input-wrapper">
      <div class="select__wrapper">
        ...
        <select class="form__select select" name="select-worker" id="select-worker">
          <option class="select__option" value="default">Добавьте блюдо</option>
          <option class="select__option" value="worker1">Крендель</option>
          <option class="select__option" value="waiter2">Пирожное</option>
          <option class="select__option" value="waiter2">Торт</option>
          <option class="select__option" value="waiter2">Яблочный рулет</option>
        </select>
      </div>
    </div>
    <div class="form__input-wrapper form__input-wrapper--row">
      <span class="form__text-content">Название блюда <span class="cross-icon">&#x2715;</span></span>
      <button class="table__button table__button--left" id="decrease-shift-button"> <svg width="30" height="30"
          viewBox="0 0 18 6" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <span class="form__text-content form__text-content--count">20
      </span>
      <button class="table__button table__button--right" id="add-shift-button">
  ...
  <button class="form__button">Создать заказ</button>
</form>